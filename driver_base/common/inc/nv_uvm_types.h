...
typedef struct UvmGpuChannelInstanceInfo_tag
{
    ...
    // Out: Info of channel resources (local CTX buffers + global CTX buffers)
...
typedef struct UvmGpuFaultInfo_tag
{
    ...
    struct
    {
        ...
        // Eecution context for the queue associated with the fault buffer
