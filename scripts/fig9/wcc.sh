...
output_path="${current_date}_wcc"
output_raw="${output_path}/raw.txt"
output_filename="wcc"
harvestor_command="docker run --gpus all --rm -it --name huvm_harvestor -v ${project_home}:/HUVM sjchoi/huvm:init python /HUVM/bench/cugraph/wcc.py --n_workers 1 --visible_devices 1,2 --dataset /HUVM/dataset/graph/web-cc12-PayLevelDomain.edges"
